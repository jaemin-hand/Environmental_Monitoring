...
public static class MonitoringProjectDefaults
{
        ...
        SamplingMode defaultSamplingMode = SamplingMode.OneMinute)
    {
        ...
        var channels = new[]
        {
            ...
            new MeasurementChannel(5, "T05", "T5", "온도 포인트 5", ChannelKind.Temperature, "degC", "TMW110-RS485", 5, true, 5m, 23m, null, null, 1m, 0m, [], IsActive: false),
            new MeasurementChannel(6, "T06", "T6", "온도 포인트 6", ChannelKind.Temperature, "degC", "TMW110-RS485", 6, true, 5m, 23m, null, null, 1m, 0m, [], IsActive: false),
            new MeasurementChannel(7, "T07", "T7", "온도 포인트 7", ChannelKind.Temperature, "degC", "TMW110-RS485", 7, true, 5m, 23m, null, null, 1m, 0m, [], IsActive: false),
            new MeasurementChannel(8, "T08", "T8", "온도 포인트 8", ChannelKind.Temperature, "degC", "TMW110-RS485", 8, true, 5m, 23m, null, null, 1m, 0m, [], IsActive: false),
